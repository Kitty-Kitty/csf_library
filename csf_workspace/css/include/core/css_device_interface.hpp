...
*
*File name: css_device_interface.hpp
*
*Version: 1.0
*
*Date: 07-10月-2018 16:50:26
*
*Description: Interface(css_device_interface) 表示css_device_interface抽象操作接口
*
*Others:
*
*History:
...
#if !defined(CSS_DEVICE_INTERFACE_H_INCLUDED_)
#define CSS_DEVICE_INTERFACE_H_INCLUDED_
...
namespace css
{
	...
	{
		/**
		 * 表示css_device_interface抽象操作接口
		 * @author fangzhenmu@aliyun.com
		 * @version 1.0
		 * @created 07-10月-2018 16:50:26
		 */
		class css_device_interface : public csf::core::system::message::csf_message_interface
		{

		public:
			css_device_interface() {

			}

			virtual ~css_device_interface() {
...
#endif // !defined(CSS_DEVICE_INTERFACE_H_INCLUDED_)
