...
* @param configure_manager    表示解析配置文件信息后，需要保存的目标对象configure_manager
*/
csf_bool csf_app_bootloader::init_devices(csf::core::module::csf_app& app
	, csf::core::system::csf_configure_manager& configure_manager) {
...
*/
csf_bool csf_app_bootloader::init_device(csf::core::module::csf_app& app
	, csf_element& element) {
...
// 		if (csf_false == init_device(app, tmp_elem)) {
// 			return csf_false;
// 		}
...
* @param configure_manager    表示解析配置文件信息后，需要保存的目标对象configure_manager
*/
csf_bool csf_app_bootloader::init_device_ioes(csf::core::module::csf_device& device
	, csf_element& element
	, csf::core::system::csf_configure_manager& configure_manager) {
...
* @param element    表示当前的device节点内容
*/
csf_bool csf_app_bootloader::init_device_io(csf::core::module::csf_device& device, csf_element& element) {
...
csf_bool csf_app_bootloader::add_device(csf::core::module::csf_app& app, csf_element& element) {
	...
	if (!csf_device_base::is_device(tmp_module->get_type())) {
		...
		if (!add_device(app, tmp_string_mid, (csf::core::module::csf_device*)tmp_module)) {
			...
			return init_device_ioes(*((csf::core::module::csf_device*)tmp_module), element, app.get_config_mg());
		}
	}
