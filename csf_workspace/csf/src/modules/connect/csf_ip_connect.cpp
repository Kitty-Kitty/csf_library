 ...
 */
csf_int32 csf_ip_connect::read(const csf_uchar* buf, const csf_uint32 len, const csf_url& url, const csf_connect_callback callback) {
 ...
 * @param callback    表示读取的回调函数
 */
csf_int32 csf_ip_connect::read(const csf_chain& chain, const csf_url& url, const csf_connect_callback callback) {
 ...
 * @param callback    表示读取的回调函数
 */
csf_int32 csf_ip_connect::read(const csf_buffer& buffer, const csf_url& url, const csf_connect_callback callback) {
 ...
 * @param callback    表示读取的回调函数
 */
csf_int32 csf_ip_connect::read(const csf_buffer& buffer, const csf_connect_callback callback) {
 ...
 * @param callback    表示读取的回调函数
 */
csf_int32 csf_ip_connect::read(const csf_uchar* buf, const csf_uint32 len, const csf_connect_callback callback) {
 ...
 * @param callback    表示读取的回调函数
 */
csf_int32 csf_ip_connect::read(const csf_csfstring& csfstr, const csf_connect_callback callback) {
 ...
 * @param callback    表示读取的回调函数
 */
csf_int32 csf_ip_connect::read(const csf_csfstring& csfstr, const csf_url& url, const csf_connect_callback callback) {
 ...
 * @param callback    表示读取的回调函数
 */
csf_int32 csf_ip_connect::read(const csf_chain& chain, const csf_connect_callback callback) {
